...
class SlidesControllerTest < ActionController::TestCase
  ...
  test "should create slide" do
    assert_difference('Slide.count') do
      post :create, slide: { body: @slide.body, image: @slide.image, title: @slide.title, tutorial_id: @slide.tutorial_id }
    end
  ...
  test "should update slide" do
    patch :update, id: @slide, slide: { body: @slide.body, image: @slide.image, title: @slide.title, tutorial_id: @slide.tutorial_id }
    assert_redirected_to slide_path(assigns(:slide))
  end
